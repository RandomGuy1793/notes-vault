...
const getNotes = async () => {
  const res = await fetch("https://nervous-puce-gloves.cyclic.app/api/notes", {
    method: "GET",
    headers: {
...
const postNote = async (noteTitle, noteText) => {
  ...
  const res = await fetch(
    "https://nervous-puce-gloves.cyclic.app/api/notes/add",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
const deleteNote = async (e) => {
  ...
  if (!isSkipped) {
    ...
    const res = await fetch(
      `https://nervous-puce-gloves.cyclic.app/api/notes/delete/${objId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
...
const editNote = async (e) => {
  ...
  if (!isSkipped) {
    ...
    const JsonData = JSON.stringify(obj);
    const res = await fetch(
      `https://nervous-puce-gloves.cyclic.app/api/notes/edit/${objId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
